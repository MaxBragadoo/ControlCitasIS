...
public class FrmClientes extends javax.swing.JFrame {
    ...
    private String nombreFormulario = "Clientes";
    Cliente objeto;
    ...
    private void inicializarForm(Cliente o) {
    ...
    private boolean validateForm() {
        try {
            ...
            if (txtCorreo.getText().trim().length() <= 0) {
                Utils.showWarning("El campo correo es requerido");
                return false;
            }
    ...
    private Cliente createObject() {
        this.objeto.setCodigoCliente(txtCodigo.getText().trim());
        ...
        this.objeto.setCorreo(txtCorreo.getText().trim());
    ...
    private void editar() {
        int id = getId();
        if (id > 0) {
            inicializarForm(ClienteBLL.find(id));
        }
    }
    ...
    private void eliminar() {
        int id = getId();
        if (id > 0) {
            if (ClienteBLL.delete(id)) {
                Utils.showInformation("Cliente eliminado");
                listar();
            } else {
                Utils.showExcepcion();
            }
    ...
    private void baja() {
        int id = getId();
        if (id > 0) {
            Cliente o = ClienteBLL.find(id);
            o.setEstatus("Baja");
            if (ClienteBLL.edit(o)) {
    ...
    private void guardar() {
        if (validateForm()) {
            if (registrar) {
                if (ClienteBLL.add(createObject())) {
                    Utils.showInformation("Cliente registrado");
                    nuevo();
                    listar();
                } else {
                    Utils.showExcepcion();
                ...
                if (ClienteBLL.edit(createObject())) {
                    Utils.showInformation("Cliente actualizado");
                    listar();
                } else {
                    Utils.showExcepcion();
                }
    ...
    private void listar() {
        if (_btnBuscar) {
            ...
            tabla.setModel(ClienteBLL.createTable((DefaultTableModel) tabla.getModel(), ClienteBLL.list(filter)));
        }
    }
    ...
    private void initComponents()
    {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cliente", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14))); // NOI18N
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lista de clientes", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14))); // NOI18N

        jLabel7.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel7.setText("Buscar por CODIGO CLIENTE o NOMBRE");
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String []
            {
                "ID", "COD. CLIENTE", "NOMBRE", "APELLIDO P.", "APELLIDO M.", "CORREO", "TELEFONO", "STATUS", "FECHA ALTA"
            }
        )
        {
